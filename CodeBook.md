...
This code book indicates all the variables and summaries calculated, along with units, and any other relevant information found in the file 'tidy.txt.'
...
* `LAYING` (value `6`): The subject was laying down during the tests
